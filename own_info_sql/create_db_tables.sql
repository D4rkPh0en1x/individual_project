CREATE DATABASE  IF NOT EXISTS `project` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `project`;
...
CREATE TABLE `user` (
  ...
  `street` varchar(60) COLLATE utf8_bin NOT NULL,
  `streetnumber` int(10) NOT NULL,
  `postalcode` int(10) NOT NULL,
  `locality` varchar(60) COLLATE utf8_bin NOT NULL,
  `country` int(11) DEFAULT NULL,
  `region` varchar(60) COLLATE utf8_bin DEFAULT NULL,
  `phonenumber` int(20) NOT NULL,
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_country` (`country`),
  CONSTRAINT `user_country` FOREIGN KEY (`country`) REFERENCES `countries` (`id`)
...
-- Dump completed on 2018-03-12 10:18:09
